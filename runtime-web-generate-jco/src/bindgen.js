...
} from "./browser/cli-base.js";
import { filesystemFilesystem as interface0 } from "./browser/filesystem.js";
import { ioStreams as interface6 } from "./browser/io.js";
import { randomRandom as interface15 } from "./browser/random.js";
...
function lowering9(arg0, arg1, arg2) {
  ...
  try {
    ret = {
      tag: "ok",
      val: lowering9Callee(arg0 >>> 0, BigInt.asUintN(64, arg1)),
    };
  } catch (e) {
    ...
    case "err": {
      ...
      switch (val0) {
        ...
        default: {
          ...
          throw new TypeError(
            `"${val0}" is not one of the cases of error-code`
          );
        }
      }
...
function lowering10(arg0, arg1, arg2) {
  ...
  try {
    ret = {
      tag: "ok",
      val: lowering10Callee(arg0 >>> 0, BigInt.asUintN(64, arg1)),
    };
  } catch (e) {
    ret = { tag: "err", val: getErrorPayload(e) };
  }
    ...
    case "ok": {
      ...
      switch (val0) {
        ...
        default: {
          ...
          throw new TypeError(
            `"${val0}" is not one of the cases of descriptor-type`
          );
        }
      }
    ...
    case "err": {
      ...
      switch (val1) {
        ...
        default: {
          ...
          throw new TypeError(
            `"${val1}" is not one of the cases of error-code`
          );
        }
      }
    ...
    case "ok": {
      ...
      switch (val1) {
        ...
        default: {
          ...
          throw new TypeError(
            `"${val1}" is not one of the cases of descriptor-type`
          );
        }
      }
...
function lowering17(arg0, arg1, arg2) {
  ...
  try {
    ret = {
      tag: "ok",
      val: lowering17Callee(arg0 >>> 0, BigInt.asUintN(64, arg1)),
    };
  } catch (e) {
    ret = { tag: "err", val: getErrorPayload(e) };
  }
...
function lowering18(arg0, arg1, arg2) {
  ...
  try {
    ret = {
      tag: "ok",
      val: lowering18Callee(arg0 >>> 0, BigInt.asUintN(64, arg1)),
    };
  } catch (e) {
    ret = { tag: "err", val: getErrorPayload(e) };
  }
  ...
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      ...
      for (let i = 0; i < len18; i++) {
        ...
        const result16 = utf8Decoder.decode(
          new Uint8Array(memory0.buffer, ptr16, len16)
        );
        const ptr17 = dataView(memory0).getInt32(base + 8, true);
        const len17 = dataView(memory0).getInt32(base + 12, true);
        const result17 = new Uint8Array(
          memory0.buffer.slice(ptr17, ptr17 + len17 * 1)
        );
      ...
      for (let i = 0; i < len23; i++) {
        ...
        const result21 = utf8Decoder.decode(
        ...
        switch (dataView(memory0).getUint8(base + 8, true)) {
          ...
          default: {
            throw new TypeError(
              "invalid discriminant specified for ExportType"
            );
          }
        }
    ...
    case 1: {
      ...
      const result24 = utf8Decoder.decode(
        new Uint8Array(memory0.buffer, ptr24, len24)
      );
      variant25 = {
        tag: "err",
        val: result24,
  ...
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      ...
      for (let i = 0; i < len17; i++) {
        ...
        const result15 = utf8Decoder.decode(
        ...
        const result16 = new Uint8Array(
          memory0.buffer.slice(ptr16, ptr16 + len16 * 1)
        );
    ...
    case 1: {
      ...
      const len18 = dataView(memory0).getInt32(ret + 8, true);
      const result18 = utf8Decoder.decode(
